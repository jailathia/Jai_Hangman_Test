...
class Hangman:
    ...
    def __init__(self, word_list, num_lives=5):
        ...
        word_guessed = list(self.word_guessed)
    ...
    def check_letter(self, letter):
        ...
        if letter.lower() in list(self.word):
            ...
            # define the positions in the word to be replaced
            positions = [pos for pos, char in enumerate(list(self.word)) if char == letter.lower()]
            # replace the letters
            for pos in positions:
                self.word_guessed[pos] = letter.lower()
            # display word with changes
            print(self.word_guessed)
            # reduce the number of letters needed by 1
            self.num_letters -= 1
...
def play_game(word_list):
    ...
    else: print(f"You ran out of lives. The word was {game.word}")
